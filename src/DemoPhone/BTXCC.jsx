...
export default class BTXCC extends Component {
    dataPhone = [
    ...
    state={
        phoneCT:{ "maSP": 1, "tenSP": "VinSmart Live", "manHinh": "AMOLED, 6.2, Full HD+", "heDieuHanh": "Android 9.0 (Pie)", "cameraTruoc": "20 MP", "cameraSau": "Chính 48 MP & Phụ 8 MP, 5 MP", "ram": "4 GB", "rom": "64 GB", "giaBan": 5700000, "hinhAnh": "./Img/phone/vsphone.jpg" },
    }
    ...
    render() {
        // let{phoneCT}= this.state
        return (
            <div className='container py-4'>
                <DSSP dataPhone={this.dataPhone} showDetail = {this.showDetail}/>
                <BangCT phoneCT = {this.state.phoneCT} />
            </div>
        )
    }
}
